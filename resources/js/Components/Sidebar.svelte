...
<aside
    class="fixed inset-y-0 left-0 z-50 transition-all duration-300 transform bg-white border-r border-gray-200 shadow-lg overflow-hidden {isOpen
        ? 'w-72 translate-x-0'
    ...
    {#if isOpen}
        <div class="absolute bottom-0 w-full p-6 border-t border-gray-100">
            <div class="flex items-center gap-4">
                <div
                    class="flex-shrink-0 w-12 h-12 overflow-hidden bg-blue-100 rounded-full"
                >
                    <img
                        src="https://ui-avatars.com/api/?name=Kader+Posyandu&background=2D9CDB&color=fff"
                        alt="User"
                    />
                </div>
                <div class="overflow-hidden">
                    <p class="text-base font-bold text-posyandu-dark truncate">
                        Ibu Kader Melati 08
                    </p>
